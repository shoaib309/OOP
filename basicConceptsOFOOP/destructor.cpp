...
public :
    ...
    */
    ...
    /* Now its a destructor when objected is created at that time we need constructor as the same when object is being deleted then we need a destructor
    and destructot don't have any type of return type. */
    ~Employee();

};

// creating a body of a destructor.
Employee :: ~Employee()
{
    cout<<"Object is beingb removed"<<endl;
